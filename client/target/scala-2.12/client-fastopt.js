...
$c_Lorg_scalajs_dom_ext_Ajax$.prototype.apply__T__T__Lorg_scalajs_dom_ext_Ajax$InputData__I__sci_Map__Z__T__s_concurrent_Future = (function(method, url, data, timeout, headers, withCredentials, responseType) {
  ...
  var this$2 = $m_sc_Iterator$().empty$1;
  while (this$2.hasNext__Z()) {
    var arg1 = this$2.next__O();
    var x = $as_T2(arg1);
    req.setRequestHeader($as_T(x.$$und1$f), $as_T(x.$$und2$f))
  };
  if ((data === null)) {
    req.send()
  } else {
...
$c_sjs_js_Thenable$ThenableOps$.prototype.toFuture$extension__sjs_js_Thenable__s_concurrent_Future = (function($$this) {
  ...
  var a = (function(p2$1$1) {
    return (function(arg1$2$1) {
      return $m_sjs_js_Thenable$ThenableOps$().scala$scalajs$js$Thenable$ThenableOps$$$anonfun$toFuture$2__O__s_concurrent_Promise__sjs_js_$bar(arg1$2$1, p2$1$1)
    })
  })(p2);
  $$this.then((function(p2$1) {
    return (function(arg1$2) {
      return $m_sjs_js_Thenable$ThenableOps$().scala$scalajs$js$Thenable$ThenableOps$$$anonfun$toFuture$1__O__s_concurrent_Promise__sjs_js_$bar(arg1$2, p2$1)
    })
  })(p2), a);
  return p2
});
$c_sjs_js_Thenable$ThenableOps$.prototype.scala$scalajs$js$Thenable$ThenableOps$$$anonfun$toFuture$2__O__s_concurrent_Promise__sjs_js_$bar = (function(e, p2$1) {
  if ($is_jl_Throwable(e)) {
    ...
    var cause = new $c_sjs_js_JavaScriptException().init___O(e)
  };
...
$c_LMain$.prototype.Main$$$anonfun$new$1__Lorg_scalajs_dom_raw_Event__s_concurrent_Future = (function(x$1) {
  var jsx$1 = $m_sjs_js_Thenable$ThenableOps$();
  var p = $g.navigator.serviceWorker.register("worker.js");
  var this$7 = jsx$1.toFuture$extension__sjs_js_Thenable__s_concurrent_Future(p);
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(e$2) {
      return $g.console.log(e$2)
    })
  })(this));
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContext();
  return $f_s_concurrent_Future__map__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$7, f, executor)
});
...
$c_LMain$.prototype.login__T__T__V = (function(uname, passwd) {
  var this$7 = $m_Lorg_scalajs_dom_ext_Ajax$();
  var array = ["http://localhost:8080/login?username=", "&password=", ""];
  var jsx$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var array$1 = [uname, passwd];
  var url = jsx$1.s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1));
  var headers = $m_sci_Map$EmptyMap$();
  var f = this$7.apply__T__T__Lorg_scalajs_dom_ext_Ajax$InputData__I__sci_Map__Z__T__s_concurrent_Future("GET", url, null, 0, headers, false, "");
  f.onComplete__F1__s_concurrent_ExecutionContext__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(x0$2$2) {
      ...
      if ($is_s_util_Success(x0$2)) {
        ...
        var xhr = x2.value$2;
        $this.token$1 = $as_T(xhr.responseText);
        var x = ("Token:" + $this.token$1);
        var this$9 = $m_s_Console$();
        var this$10 = $as_Ljava_io_PrintStream(this$9.outVar$2.v$1);
        this$10.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"))
...
$c_LMain$.prototype.ping__V = (function() {
  var this$7 = $m_Lorg_scalajs_dom_ext_Ajax$();
  var array = ["http://localhost:8080/ping?token=", ""];
  var jsx$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var array$1 = [this.token$1];
  var url = jsx$1.s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1));
  var headers = $m_sci_Map$EmptyMap$();
  ...
  f.onComplete__F1__s_concurrent_ExecutionContext__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(x0$1$2) {
      ...
      if ($is_s_util_Success(x0$1)) {
        ...
        var b = this$11.parseLong__T__I__J($$this, 10);
        var bhi = b.hi$2;
        var lo$1 = ((lo - b.lo$2) | 0);
        var hi$1 = ((((-2147483648) ^ lo$1) > ((-2147483648) ^ lo)) ? (((-1) + ((hi - bhi) | 0)) | 0) : ((hi - bhi) | 0));
        var x$1 = $m_sjsr_RuntimeLong$().scala$scalajs$runtime$RuntimeLong$$toString__I__I__T(lo$1, hi$1);
        ...
        this$18.java$lang$JSConsoleBasedPrintStream$$printString__T__V("not logged in!\n")
      } else {
...
$c_LMain$.prototype.$$js$exported$meth$Download__O = (function() {
  this.Download__V()
});
$c_LMain$.prototype.delayedEndpoint$Main$1__V = (function() {
  this.token$1 = "";
  var v = $g.navigator.serviceWorker;
  if ((!(v === (void 0)))) {
    $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().addEventListener("load", (function(arg1$2) {
      return $m_LMain$().Main$$$anonfun$new$1__Lorg_scalajs_dom_raw_Event__s_concurrent_Future(arg1$2)
    }))
  } else {
    $m_Lorg_scalajs_dom_package$().console__Lorg_scalajs_dom_raw_Console().log("registration failed!")
  };
  var v$1 = $g.navigator.serviceWorker;
  if ((!(v$1 === (void 0)))) {
    $g.navigator.serviceWorker.addEventListener("message", (function($this) {
      return (function(event$2) {
        var jsx$1 = $m_Lorg_scalajs_dom_package$().console__Lorg_scalajs_dom_raw_Console();
        var s = $objectToString(event$2.data);
        jsx$1.log(s)
      })
    })(this))
  };
...
$c_LMain$.prototype.login = (function(arg$1, arg$2) {
  var prep0 = $as_T(arg$1);
  var prep1 = $as_T(arg$2);
  return this.$$js$exported$meth$login__T__T__O(prep0, prep1)
});
$c_LMain$.prototype.ping = (function() {
  return this.$$js$exported$meth$ping__O()
});
...
$c_LMain$delayedInit$body.prototype.apply__O = (function() {
  this.$$outer$2.delayedEndpoint$Main$1__V()
});
